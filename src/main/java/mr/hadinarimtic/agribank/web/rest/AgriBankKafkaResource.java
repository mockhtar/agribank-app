...
@RestController
@RequestMapping("/api/agri-bank-kafka")
public class AgriBankKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AgriBankKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AgriBankKafkaResource(KafkaProperties kafkaProperties) {
